      ...
      <div className="border-t border-neutral-200">
        <div className="mx-auto max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1920px] px-4 py-4 sm:py-6 sm:px-6 lg:px-8 xl:px-10">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start text-xs sm:text-sm text-gray-600">
            ...
            {/* Row 2: Language + Currency + Social */}
            <div className="flex items-center justify-center md:justify-end gap-4">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs sm:text-sm font-medium text-gray-700 hover:text-gray-900 transition-colors"
              >
