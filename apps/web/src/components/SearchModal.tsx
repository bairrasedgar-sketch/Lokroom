    ...
    <div className="fixed inset-0 z-[100] flex items-start sm:items-start justify-center pt-0 sm:pt-20 bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 sm:px-6 py-3 bg-gray-50 border-b border-gray-100 overflow-x-auto">
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs sm:text-sm flex-shrink-0 ${destination ? "bg-[#E85D4C] text-white" : "bg-white border border-gray-200 text-gray-500"}`}>
          ...
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs sm:text-sm flex-shrink-0 ${startDate ? "bg-[#E85D4C] text-white" : "bg-white border border-gray-200 text-gray-500"}`}>
            <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs sm:text-sm flex-shrink-0 ${guests > 1 ? "bg-[#E85D4C] text-white" : "bg-white border border-gray-200 text-gray-500"}`}>
            <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 bg-gray-50">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#E85D4C] hover:bg-[#D14836] text-white rounded-xl font-medium transition-colors"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
