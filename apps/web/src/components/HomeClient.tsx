  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden rounded-3xl sm:rounded-xl bg-gray-100">
        ...
        {hasMultipleImages && (
          <>
            {/* Mobile: flèches avec petit rond gris / Desktop: avec fond blanc */}
            <button
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
              ...
              className={`absolute left-1.5 top-1/2 -translate-y-1/2 flex items-center justify-center rounded-full sm:h-7 sm:w-7 sm:bg-white/90 sm:shadow-sm sm:border sm:border-gray-200/50 transition-all sm:hover:bg-white sm:hover:scale-105 sm:hover:shadow-md z-10 ${isHovered ? 'sm:opacity-100' : 'sm:opacity-0'}`}
              style={{ height: '14px', width: '14px', backgroundColor: 'rgba(209, 213, 219, 0.7)' }}
            >
              <svg style={{ height: '10px', width: '10px' }} className="sm:h-3 sm:w-3 text-gray-600 sm:text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
            ...
            <button
              ...
              className={`absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center justify-center rounded-full sm:h-7 sm:w-7 sm:bg-white/90 sm:shadow-sm sm:border sm:border-gray-200/50 transition-all sm:hover:bg-white sm:hover:scale-105 sm:hover:shadow-md z-10 ${isHovered ? 'sm:opacity-100' : 'sm:opacity-0'}`}
              style={{ height: '14px', width: '14px', backgroundColor: 'rgba(209, 213, 219, 0.7)' }}
            >
              <svg style={{ height: '10px', width: '10px' }} className="sm:h-3 sm:w-3 text-gray-600 sm:text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
