  ...
  return (
    <div className="relative">
      ...
      <div className="lg:hidden">
        ...
        {/* Bouton Carte flottant style Airbnb - en bas au centre */}
        {mobileSheetPosition !== 'collapsed' && (
          <button
            ...
            className="fixed left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 rounded-full bg-gray-900 px-4 py-3 text-sm font-semibold text-white shadow-lg active:scale-95 transition-transform"
            style={{
              bottom: `calc(${sheetHeight}vh + 16px)`,
        ...
        {/* Barre en bas avec nombre d'annonces - visible quand sheet collapsed */}
        {mobileSheetPosition === 'collapsed' && (
          <div
            className="fixed left-0 right-0 bottom-0 z-40 bg-white border-t border-gray-200 px-4 py-3 flex items-center justify-between safe-area-bottom"
          >
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-full bg-gray-900 px-4 py-2 text-sm font-semibold text-white active:scale-95 transition-transform"
            >
              <span>Liste</span>
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
