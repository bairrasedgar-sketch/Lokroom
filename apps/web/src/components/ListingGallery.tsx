        ...
        <div className="grid grid-cols-2 gap-2 rounded-xl overflow-hidden relative">
          ...
          {total > 1 && (
            <button
              type="button"
              onClick={() => openModal(0)}
              className="absolute top-4 left-4 z-10 px-4 py-2 bg-white/80 backdrop-blur-sm text-gray-900 text-sm font-semibold rounded-lg hover:bg-white/90 transition-colors flex items-center gap-2 shadow-sm border border-gray-300/50"
            >
