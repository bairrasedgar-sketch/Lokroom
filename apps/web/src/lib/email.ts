...
function emailHeader(): string {
  return `
    <div style="background:#111111;padding:12px 32px 12px 8px;">
      <img src="${APP_URL}/email-logo.webp" alt="Lok'Room" style="height:70px;width:auto;display:block;margin:0;" />
    </div>
  `;
}
