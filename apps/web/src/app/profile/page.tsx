                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showAboutMe ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showAboutMe ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <textarea
                      value={publicAboutMe}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showCity ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showCity ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <input
                      type="text"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showCountry ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showCountry ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <input
                      type="text"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showJobTitle ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showJobTitle ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <input
                      type="text"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showLanguages ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showLanguages ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <input
                      type="text"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-[26px] w-12 items-center flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out ${showInterests ? "bg-gray-900" : "bg-gray-300"}`}
                      >
                        <span className={`pointer-events-none inline-block h-[22px] w-[22px] transform rounded-full bg-white shadow transition duration-200 ease-in-out ${showInterests ? "translate-x-[26px]" : "translate-x-[2px]"}`} />
                      </button>
                    </div>
                    <input
                      type="text"
