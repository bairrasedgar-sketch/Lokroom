              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  ...
                  {listing.owner.createdAt && (() => {
                    const createdYear = new Date(listing.owner.createdAt).getFullYear();
                    const currentYear = new Date().getFullYear();
                    // Only show if year is valid (2025 or later for Lokroom)
                    if (createdYear >= 2025 && createdYear <= currentYear) {
                      return (
                        <div className="inline-flex items-center gap-1 rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-700">
                          <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                          </svg>
                          Hôte depuis {createdYear}
                        </div>
                      );
                    }
                    return null;
