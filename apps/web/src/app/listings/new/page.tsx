        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
          ...
          {currentStep === "type" && (
            <div className="space-y-4 lg:space-y-6 px-4 lg:px-0">
              <div className="rounded-xl bg-blue-50 border border-blue-200 p-3 lg:p-4">
                ...
                {LISTING_TYPES.map((t) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex items-start gap-3 lg:gap-4 rounded-xl border-2 p-3 lg:p-4 text-left transition-all hover:border-gray-400 ${
                        isPrimary
